...
function Pending() {
  ...
  useEffect(() => {
    axios
      .get("/api/v1/users/orders/search?filter=PENDING&page=" + page)
  ...
  return (
    <>
      <Header />
      <div className={cx("pending_wrapper")}>
        <div className={cx("pending_container")}>
          <NavBar />
              ...
              <div className={cx("purchase_item")} key={index}>
                <div className={cx("purchase_item-info")}>
                  ...
                  {order.orderDetails.map((item, i) => (
                    <div className={cx("purchase_item-detail")} key={i}>
                ...
                <div className={cx("purchase_item-options")}>
                  ...
                  <div className={cx("button")}>
                    ...
                    <button className={cx("contact-btn")}>CANCEL</button>
                  </div>
                </div>
              </div>
            ))
