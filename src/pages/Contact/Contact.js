            ...
            <div className={cx('contact-container')}>
                <div className={cx('contact-details')}>
                    ...
                    <div className={cx('contact-info')}>
                        ...
                        <span> Interactively grow empowered for process-centric total linkage</span>
                    </div>
                </div>
                <div className={cx('contact-details')}>
                    ...
                    <div className={cx('contact-info')}>
                        ...
                        <span> Distinctively disseminate focused solutions clicks-and-mortar ministate</span>
                    </div>
                </div>
                <div className={cx('contact-details')}>
